...
_Outil de vérification de conformité des données --- Bridge bd_bank_
...
(mock) en attendant la semaine 4._
...
_Cette roadmap suppose un rythme de travail régulier sur 5 jours par
